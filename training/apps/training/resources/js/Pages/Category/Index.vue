        ...
        <tbody>
          <tr
            ...
            <td class="px-6 py-4 text-right">
              <a :href="category.edit_url" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
              <a @click="destroy(category.id)" class="font-medium text-red-600 dark:text-red-500 hover:underline ml-4 hover:cursor-pointer">Delete</a>
            </td>
          </tr>
        </tbody>
      </table>
